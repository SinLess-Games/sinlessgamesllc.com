import { CardProps } from "../../components/reusable-components/card"

export const GameDesignCard: CardProps = {
  title: "Game Design",
  description:
...
export const WebDesignCard: CardProps = {
  title: "Web Design",
  description:
...
export const TechResearchCard: CardProps = {
...
export const CommunityCard: CardProps = {
  title: "Community",
  quote:
...
export const CustomPCsCard: CardProps = {
  title: "Custom PCs",
  description:
...
export const HomeNetworkCard: CardProps = {
  title: "Home Network",
  description:
...
export const SmartHomeCard: CardProps = {
  title: "Smart Home",
  description:
...
export const HomeAutomationCard: CardProps = {
...
export const HomeSecurityCard: CardProps = {
  title: "Home Security",
  description:
